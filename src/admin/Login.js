...
const Login = () => {
  ...
  return (
      <div className='w-100 min-vh-100 row bg-warning ms-0 bg-opacity-25 py-5 overflow-hidden'>
          <div className='col-lg-6 me-5 align-self-center'><img  className='w-100' src={log} alt='sample'/></div>
          <div className='align-self-center col-lg-5 col-12 my-5 bg-light p-5 rounded-3 h-75'>
            <h2 className='w-100 fs-1 my-4 text-center'>Admin Login</h2>
            <p className='p-1 px-5 mx-5 text-center'>Please enter your credentials <br></br>to access the admin dashboard.</p>
            ...
            <div className='my-3 w-100 text-center'><a className='text-black' href='/admin/forgetpass'>Did you forgot Password??</a></div>
            <div className='my-3 w-100 text-center'>Are you a student?<a className='text-black' href='/student/login'>Click This</a></div>
          </div>
